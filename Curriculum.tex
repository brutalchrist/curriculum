...
\documentclass[11pt,a4paper,roman]{moderncv}   % opciones posibles incluyen tamaÃ±o de fuente ('10pt', '11pt' and '12pt'), tamaÃ±o de papel ('a4paper', 'letterpaper', 'a5paper', 'legalpaper', 'executivepaper' y 'landscape') y familia de fuentes ('sans' y 'roman')
...
\address{Vicuña Mackenna 58 ~ Providencia}{Santiago}
\phone[mobile]{+56~(9)~71768325}                     
...
%\cventry{2007--2009}{Ingeniería Civil Informática}{Universidad Católica del Maule}{Talca}{}{Incompleta}
...
\section{Habilidades}
	\cvitemwithcomment{Desarrollo Web}{}{PHP, Javascript, jQuery, Ajax, Java, JSF, Richfaces, Primefaces}
	\cvitemwithcomment{Bases de datos}{}{Oracle, MySQL, Postgres}
	\cvitemwithcomment{Serv. Aplicaciones}{}{Apache, Weblogic, JBoss}


\section{Experiencia Laboral}
\cventry{2015--Actual}{Desarrollador de Software}{LemonTech}{Santiago}{}{Empresa dedicada al desarrollo de soluciones para abogados.\newline{}%
\begin{itemize}%
	\item The Timebilling: Software de gestión legal.
	\begin{itemize}%
		\item Desarrollo web con backend: PHP. Frontend:  HTML, jQuery, Javascript y Ajax.
...
\begin{itemize}%
	...
	\begin{itemize}%
		\item Desarrollo web con backend: Java. Frontend:  JSF y Richfaces.
	...
	\begin{itemize}%
		\item Desarrollo web con backend: Java. Frontend:  JSF y Primefaces.
